...
function matrixEntSpreizung(keyword: string, keynumbers: string, alphabet: string, input: string) {
    // Entschlüsselung nach Spreizung/ Straddling Checkerboard.
    // Alphabet Reihenfolge setzen.
    // Wenn Zeichen im keyword aber nicht im Alphabet enthalten sind, werden diese hinzugefügt.
    alphabet = keyword + alphabet;
...
function SpreizungsParameterCheck(keyword: string, keynumbers: string, alphabet: string, input: string): string {
...
function entSpreizungsParameterCheck(keyword: string, keynumbers: string, alphabet: string, input: string): string {
