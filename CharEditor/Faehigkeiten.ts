...
const kaempferFaehigkeiten: Faehigkeit[] = [EinfacheWaffen, KriegsWaffen];
const schuetzenFaehigkeiten: Faehigkeit[] = [EinfacheWaffen,KriegsWaffen,BlattSchuss,];
const magierFaehigkeiten: Faehigkeit[] = [EinfacheWaffen,MagieWirken,];
const klerikerFaehigkeiten: Faehigkeit[] = [EinfacheWaffen,Beten,HandAuflegen];
const diebfaehigkeiten: Faehigkeit[] = [EinfacheWaffen,Schleichen, BlattSchuss];
const druideFaehigkeiten: Faehigkeit[] = [EinfacheWaffen,NaturKunde, HandAuflegen];
const paladinFaehigkeiten: Faehigkeit[] = [EinfacheWaffen,KriegsWaffen,HandAuflegen];
// faehigkeitenArray muss in Reihenfolge des enum Klasse aufgebaut sein. 
const faehigkeitenArray: Faehigkeit[][] = [kaempferFaehigkeiten,schuetzenFaehigkeiten,magierFaehigkeiten,klerikerFaehigkeiten,diebfaehigkeiten,druideFaehigkeiten,paladinFaehigkeiten];

function getFaehigkeitenArray(klassenIndex: number): Faehigkeit[] {
