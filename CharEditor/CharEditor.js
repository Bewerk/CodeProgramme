...
function refreshFaehigkeitenliste(Attribute) {
...
function onChangeAttribut(attributIndex, plusElseMinus) {
...
function onSelectVolk() {
    let volk = document.getElementById('VolksWahl').value;
    let list = document.getElementsByClassName('VolksBeschreibung');
    for (const x of list) {
...
function onSelectCharKlasse() {
    let charKlasse = document.getElementById('KlassenWahl').value;
    let list = document.getElementsByClassName('KlassenBeschreibung');
    for (const x of list) {
        x.style.display = 'none';
    }
...
function resetSelects() {
    document.getElementById('VolksWahl').value = 'Mensch';
    document.getElementById('KlassenWahl').value = 'Kaempfer';
}
/*
function onMinusStr() {
    minusStr();
...
*/ 
//# sourceMappingURL=CharEditor.js.map